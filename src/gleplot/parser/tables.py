...
COLORS: Dict[str, Tuple[int, int, int]] = {
    ...
    "GOLD": (255, 215, 0), "GOLDENROD": (218, 165, 32), "GRAY": (128, 128, 128), "GRAY1": (253, 253, 253),
    "GRAY10": (200, 200, 200), "GRAY20": (175, 175, 175), "GRAY30": (150, 150, 150), "GRAY40": (125, 125, 125),
    "GRAY5": (240, 240, 240), "GRAY50": (100, 100, 100), "GRAY60": (75, 75, 75), "GRAY70": (50, 50, 50),
    "GRAY80": (25, 25, 25), "GRAY90": (6, 6, 6), "GREEN": (0, 128, 0), "GREENYELLOW": (173, 255, 47),
    "HONEYDEW": (240, 255, 240), "HOTPINK": (255, 105, 180), "INDIANRED": (205, 92, 92), "INDIGO": (75, 0, 130),
    "IVORY": (255, 255, 240), "KHAKI": (240, 230, 140), "LAVENDER": (230, 230, 250), "LAVENDERBLUSH": (255, 240, 245),
    "LAWNGREEN": (124, 252, 0), "LEMONCHIFFON": (255, 250, 205), "LIGHTBLUE": (173, 216, 230), "LIGHTCORAL": (240, 128, 128),
    "LIGHTCYAN": (224, 255, 255), "LIGHTGOLDENRODYELLOW": (250, 250, 210), "LIGHTGRAY": (211, 211, 211), "LIGHTGREEN": (144, 238, 144),
    "LIGHTPINK": (255, 182, 193), "LIGHTSALMON": (255, 160, 122), "LIGHTSEAGREEN": (32, 178, 170), "LIGHTSKYBLUE": (135, 206, 250),
    "LIGHTSLATEGRAY": (119, 136, 153), "LIGHTSTEELBLUE": (176, 196, 222), "LIGHTYELLOW": (255, 255, 224), "LIME": (0, 255, 0),
    "LIMEGREEN": (50, 205, 50), "LINEN": (250, 240, 230), "MAGENTA": (255, 0, 255), "MAROON": (128, 0, 0),
    "MEDIUMAQUAMARINE": (102, 205, 170), "MEDIUMBLUE": (0, 0, 205), "MEDIUMORCHID": (186, 85, 211), "MEDIUMPURPLE": (147, 112, 219),
...
MARKERS = frozenset({
    "ASTERISK", "ASTERIX", "CIRCLE", "CLUB", "CROSS", "DAG", "DDAG", "DIAMOND",
    "DIAMONDZ", "DOT", "FCIRCLE", "FDIAMOND", "FLOWER", "FSQUARE", "FSTARR",
    "FTRIANGLE", "FTRIANGLED", "HANDPEN", "HEART", "LETTER", "MINUS", "ODOT",
    "OMINUS", "OPLUS", "OTIMES", "PCROSS", "PHONE", "PLANE", "PLUS", "SCIRCLE",
    "SNAKE", "SPADE", "SQUARE", "SSQUARE", "STAR", "STAR2", "STAR3", "STAR4",
    "STARR", "TRIANGLE", "TRIANGLED", "TRIANGLEZ", "WCIRCLE", "WDIAMOND",
    "WTRIANGLE", "WTRIANGLED", "WSQUARE", "WSTARR",
})
